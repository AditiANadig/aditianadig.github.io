...
<body>
  ...
  <div class="orderdetails w3-animate-opacity">
    <span class="placed" style="font-size:2.3rem;">Your order has been placed!</span> <br /><br />
    ...
    if ($result3->num_rows > 0)
    {
      ...
      while($row3 = $result3->fetch_assoc()) {
        ...
        $sql2 = "INSERT INTO orders (order_id, user_id, food_id, food_qty, user_name, user_phone, user_address, timestamp) VALUES ('$order_id', '$u_id', '$f_id', '$f_qty', '$u_name', '$u_phone', '$u_address', '$timest')";
