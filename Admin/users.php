  ...
  <div class="row mainrow">
    <div class="col-md-2">
      <div class="sidebar">
        ...
        <a class="active" href="users.php"><i class="fas fa-users"></i> &nbspUsers</a>
        <a href="../logout_action.php"><i class="fas fa-sign-out-alt"></i> &nbspMain Page</a>
      </div>
    </div>
    <div class="col-md-10">
      <div class="userboard">
        <div class="dash dashhead w3-animate-opacity">USERS</div>
        <table class="table table-dark table-hover w3-animate-opacity">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a href="" class="trash"><i class="fas fa-trash-alt trash"></i></a></td>
            </tr>
          <?php } else {?>
            <tr>
              <th scope="row"><?php echo $row1["id"] ?></th>
